<template>
    <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" font-size="24px">
        <circle cx="12.5" cy="12.5" r="9.5" stroke="currentColor" stroke-width="1.5"></circle>
        <path
