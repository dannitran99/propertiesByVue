...
import { ModuleContent, ModuleTitle, ModuleParagraph, ModuleImage, ModuleVideo, ModuleTable, ModuleList, ModuleMoreArticle } from '@/components/ModuleContent'
...
export default {
  components: { SideBar, ModuleContent, ModuleTitle, ModuleParagraph, ModuleImage, ModuleVideo, ModuleTable, ModuleList, ModuleMoreArticle },
  data() {
    return {
      tags: DEFAULT_TAGS,
      isDragging: false,
